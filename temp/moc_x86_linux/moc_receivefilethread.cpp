...
QT_MOC_LITERAL(9, 85, 15), // "receiveFinished"
QT_MOC_LITERAL(10, 101, 11), // "ReceiveData"
QT_MOC_LITERAL(11, 113, 10), // "DisConnect"
QT_MOC_LITERAL(12, 124, 18), // "displaySocketError"
...
void ReceiveFileThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ReceiveFileThread::receiveFinished)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void ReceiveFileThread::receiveFinished()
{
